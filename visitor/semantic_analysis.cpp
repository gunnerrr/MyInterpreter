...
void SemanticAnalyser::visit(parser::ASTSqrtNode *sqrt) {

    // Update current expression
    sqrt -> expr -> accept(this);
}

void SemanticAnalyser::visit(parser::ASTFactNode *fact) {

    // Update current expression
    fact -> expr -> accept(this);
}
void SemanticAnalyser::visit(parser::ASTSinNode *sinus) {

    // Update current expression
    sinus -> expr -> accept(this);
}
void SemanticAnalyser::visit(parser::ASTCosNode *cosinus) {

    // Update current expression
    cosinus -> expr -> accept(this);
}
void SemanticAnalyser::visit(parser::ASTTangNode *tang) {

    // Update current expression
    tang -> expr -> accept(this);
}
void SemanticAnalyser::visit(parser::ASTLogNode *log) {
