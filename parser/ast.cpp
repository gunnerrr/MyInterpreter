...
ASTSqrtNode::ASTSqrtNode(ASTExprNode *expr, unsigned int line_number) :
        expr(expr),
        line_number(line_number)
{}

ASTFactNode::ASTFactNode(ASTExprNode *expr, unsigned int line_number) :
        expr(expr),
        line_number(line_number)
{}

ASTSinNode::ASTSinNode(ASTExprNode *expr, unsigned int line_number) :
        expr(expr),
        line_number(line_number)
{}
ASTCosNode::ASTCosNode(ASTExprNode *expr, unsigned int line_number) :
        expr(expr),
        line_number(line_number)
{}
ASTTangNode::ASTTangNode(ASTExprNode *expr, unsigned int line_number) :
        expr(expr),
        line_number(line_number)
{}
ASTLogNode::ASTLogNode(ASTExprNode *expr, unsigned int line_number) :
        expr(expr),
        line_number(line_number)
{}
...
void ASTSqrtNode::accept(visitor::Visitor *v){
    v -> visit(this);
}

void ASTFactNode::accept(visitor::Visitor *v){
    v -> visit(this);
}

void ASTSinNode::accept(visitor::Visitor *v){
    v -> visit(this);
}

void ASTCosNode::accept(visitor::Visitor *v){
    v -> visit(this);
}

void ASTTangNode::accept(visitor::Visitor *v){
    v -> visit(this);
}

void ASTLogNode::accept(visitor::Visitor *v){
    v -> visit(this);
}
